...
import static com.example.chatlink.ViewStoryActivity.FILE_TYPE;
import static com.example.chatlink.ViewStoryActivity.VIDEO_URL_KEY;
...
import com.example.chatlink.StoryAddActivity;
import com.example.chatlink.ViewStoryActivity;
import com.example.chatlink.model.StoriesModel;
...
public class StoriesAdapter extends RecyclerView.Adapter<StoriesAdapter.StoriesHolder> {
    ...
    public void onBindViewHolder(@NonNull StoriesAdapter.StoriesHolder holder, @SuppressLint("RecyclerView") int position) {
        if (position == 0) {
            Glide.with(activity)
                    .load(activity.getResources().getDrawable(R.drawable.ic_plus))
